...
final class HostStoreTests: XCTestCase {
    ...
    func makeStore(
        ...
        configureCodexDesktopSync: @escaping @Sendable (Bool, Bool) async throws -> CodexDesktopSyncConfigurationResult = { enabled, _ in
        ...
        let agent = AgentCommandClient(
            ...
            configureCodexDesktopSync: configureCodexDesktopSync,
