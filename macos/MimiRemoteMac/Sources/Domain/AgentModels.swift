...
struct CodexDesktopSyncConfigurationResult: Codable, Equatable, Sendable {
    let enabled: Bool
    let changed: Bool
    ...
    enum CodingKeys: String, CodingKey {
        case enabled
        case changed
        case serviceRestartRequired = "service_restart_required"
        case legacyCleanupRequired = "legacy_cleanup_required"
        case message
    }
    ...
    init(
        enabled: Bool,
        changed: Bool = false,
        serviceRestartRequired: Bool = false,
        legacyCleanupRequired: Bool = false,
        message: String = ""
    ) {
...
struct AgentRuntimeStatus: Codable, Equatable, Identifiable, Sendable {
    ...
    let desktopSync: CodexDesktopSyncStatus?
    ...
    init(
        ...
        desktopSync: CodexDesktopSyncStatus? = nil
    ) {
        self.id = id
        self.title = title
        self.enabled = enabled
...
enum CodexDesktopSyncState: String, Codable, Equatable, Sendable {
    case disabled
    case notInstalled = "not_installed"
    case desktopNotRunning = "desktop_not_running"
    case connecting
    case ready
...
struct CodexDesktopSyncStatus: Codable, Equatable, Sendable {
    let enabled: Bool
    let state: CodexDesktopSyncState
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case desktopBuild = "desktop_build"
        case profile
    }

    init(
        enabled: Bool = false,
        state: CodexDesktopSyncState = .disabled,
        transport: String? = nil,
        desktopVersion: String? = nil,
        desktopBuild: String? = nil,
        profile: String? = nil
    ) {
        self.enabled = enabled
        self.state = state
